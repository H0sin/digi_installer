...
envsubst '$DOMAIN,$RABBITMQ_DOMAIN,$PGADMIN_DOMAIN,$PORTAINER_DOMAIN,$HAPROXY_STATS_PASS' < /usr/local/etc/haproxy/haproxy.cfg.template > /usr/local/etc/haproxy/haproxy.cfg
